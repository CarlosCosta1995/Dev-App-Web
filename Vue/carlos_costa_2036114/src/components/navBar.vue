          ...
          <b-navbar type="dark" >
            <b-navbar-nav>
              <b-nav-item >
                ...
                <router-link to="/" style="color: white;"> The Newah</router-link>
              </b-nav-item>
              ...
              <b-nav-item-dropdown text="Explore" right>
                <b-dropdown-item href="/#ship">
                  ...
                  <!-- <router-link to="ship"> SpaceShip</router-link> -->
                </b-dropdown-item>

                <b-dropdown-item href="/#races">
                ...
                <b-dropdown-item>
                  ...
                  </svg><router-link to="/solarSystem"> The Solar System</router-link>
                </b-dropdown-item>
                ...
                <b-dropdown-item href="#">
                  ...
                  </svg><router-link to="/timeLine"> Universe System</router-link>
                </b-dropdown-item>
              </b-nav-item-dropdown>
              ...
              <b-nav-item-dropdown text="User" right>
                ...
                <b-dropdown-item>
                  ...
                  <router-link to="/admin"> Contact Us</router-link>
                </b-dropdown-item>
              </b-nav-item-dropdown>
            </b-navbar-nav>
          </b-navbar>
